...
# meta_data_subset <- meta_data[idx,];


write.csv(express_matrix, "01_expressMatrix.geneLevel_RSEM_TPM_filtered.csv")

# Also output the filtered meta data, where the row ordering should be the same as the column ordering of the expression data
